(function() {
	...
	//定义了一个叫 $ 的function
	/**
	 * In JavaScript, options objects are a common pattern for passing arguments into a function.
	 */
	...
	//定义了ajax 对 api call 的模式
	// passed in some functions
	 ...
	 * @PARAM items - array JSON objects
	 */
	...
	function addItem(itemList, item) {
		...
		var title = $('a', {
			href : item.url,
			//_blank: open up a new tab when clicked on the link
			target : '_blank',
			className : 'item-name'
		});
...
//				'');
	...
	function loadNearbyItems() {
		...
		// successful callback for the callback parameter
		function(res) {
//			console.log("AFTER loading Nearby events........");
//			console.log(res);
	...
	function changeFavoriteItem(item_id) {
		...
		console.log("favorite for this item is currently: " + favorite);

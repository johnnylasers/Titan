...
public class TicketMasterAPI implements ExternalAPI{
	...
	private static final String API_KEY = "gwo1HM9GIl2oihoZSNU7m5byQ9cdfA7S";
	...
	public List<Item> search(double lat, double lon, String term) {
		...
		try {
			...
			//BufferedReader会等着input stream，直到取得至少一行
			...
			// JSONObject class capable of doing string deserialization
	...
	//query as parameters for the URL
